...
// With insertion of 'commentText' the """ Quotation for the docstring don't close. Poor man's fix: append """"
    commentText() {
        this.appendText("\n# References \n");
        this.appendText("* [");
        this.appendPlaceholder("<Insert link description>");
        this.appendText("](");
        this.appendPlaceholder("<URL or relative path to file in repo>");
        this.appendText(")");
        this.appendNewLine();
        this.appendText('"""');  
    }
